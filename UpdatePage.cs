...
namespace HotelBooking
{
    ...
    {
        DataClasses1DataContext searchData = new DataClasses1DataContext();
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            Table tblUpdate = searchData.Tables.FirstOrDefault(usr => usr.CustID==(textBox1.Text));

           
            if (textBoxcustomerName.Text != "")
            {
               
                tblUpdate.CustName = textBoxcustomerName.Text;
            }

            if (textBoxphoneNo.Text != "")
            {
              tblUpdate.CustPhNo = textBoxphoneNo.Text;
            }
            if (textBoxemail.Text != "")
             {
               tblUpdate.CustEmail = textBoxemail.Text;
             }

               searchData.SubmitChanges();
        ...
        private void labelUpdateID_Click(object sender, EventArgs e)
        {
        ...
        {
            var update = from data in searchData.Tables where (data.CustID == textBox1.Text || data.CustName == textBox1.Text) select data;
            foreach (Table data in update)
            {
               
                label3.Text = data.CustName;
                label4.Text = data.CustPhNo;
                label5.Text = data.CustEmail;
            }
