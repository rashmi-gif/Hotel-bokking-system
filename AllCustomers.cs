...
namespace HotelBooking
{
    public partial class AllCustomers : Form
    {
       ...
       // Table userTable = new Table();
        ...
        {
            // TODO: This line of code loads data into the 'dBtable1DataSet.Table' table. You can move, or remove it, as needed.
            //this.tableTableAdapter.Fill(this.dBtable1DataSet.Table);
            //showDataCustomer();


            dataGridViewAllCustomers.DataSource = searchData.Tables;
        }
